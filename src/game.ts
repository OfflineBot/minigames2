...
export class Game {
    ...
    private _players: { id: string, name: string }[];         // players from socket.io
    private _player_order: { id: string, user: { name: string, content: string } }[][];  // shuffled players in all orders
    ...
    add_player(id: string, name: string) {
    ...
    set_player_text_element(content: string, idx: number, id: string) {
    ...
    get_playername_by_id(id: string) {
    ...
    generate_prev(idx: number, current_id: string) {
